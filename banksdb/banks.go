...
var banksByCountry = map[Country][]Bank{
	...
	AU: {
		{
			...
			Color:      "#007dba",
			Prefixes:   []int{407220, 450949, 456462, 456468, 456469, 546827},
		},
		{
			Name:       "bwe",
			Country:    "au",
			...
			Color:      "#f79534",
			Prefixes:   []int{456444, 522980, 528013, 532737, 540482, 543568},
		},
		{
			Name:       "cba",
			Country:    "au",
			...
			Color:      "#f3c40e",
			Prefixes:   []int{405221, 494052, 494053, 521729, 535316, 535318, 535319, 552033, 555005},
		},
		{
			Name:       "go",
			Country:    "au",
	...
	BY: {
		...
		},
		{
			...
			Color:      "#ee3124",
			Prefixes:   []int{437350, 458520, 458521, 458522, 458523},
		},
		{
			Name:       "belapb",
			Country:    "by",
			...
			Color:      "#fab606",
			Prefixes:   []int{432036, 432037, 432038, 432039, 432040, 432041, 520195, 522208, 532308, 547232},
		},
		{
			Name:       "belarusbank",
			Country:    "by",
			...
			Color:      "#127d49",
			Prefixes:   []int{401803, 409087, 424641, 425519, 425520, 425521, 510035, 543044, 543634, 544598, 547087, 547091, 547504, 557075, 557076},
		},
		{
			...
			URL:        "http://www.bnb.by",
			Color:      "#f89828",
			Prefixes:   []int{450040, 450041, 450042, 489062},
		},
		{
			Name:       "belgazprom",
			Country:    "by",
			...
			Color:      "#0079c2",
			Prefixes:   []int{428620, 428621, 428622, 428623, 428624, 518597, 518707, 529922},
		},
		{
			Name:       "belinvestbank",
			Country:    "by",
			...
			Color:      "#009881",
			Prefixes:   []int{401346, 434484, 434485, 434486, 434487, 458291, 547691, 557749, 557884, 557885},
		},
		{
			Name:       "belswissbank",
			Country:    "by",
		...
		},
		{
			...
			Color:      "#f37637",
			Prefixes:   []int{414088, 414297, 414298, 422887, 447514, 447515, 470469, 499835, 520658, 537000, 544206, 544578, 544650, 547747, 548475},
		},
		{
			Name:       "bpssberbank",
			Country:    "by",
			...
			Color:      "#1b991b",
			Prefixes:   []int{413856, 413857, 431836, 431837, 431838, 437449, 540234, 544454, 558682},
		},
		{
			Name:       "deltabank",
			Country:    "by",
			...
			Color:      "#d81e05",
			Prefixes:   []int{467939, 467940, 467941},
		},
		{
			Name:       "homecredit",
			Country:    "by",
			...
			Color:      "#e03a3e",
			Prefixes:   []int{510415, 510428, 528065},
		},
		{
			Name:       "moskvaminsk",
			Country:    "by",
		...
		},
		{
			...
			Color:      "#005aab",
			Prefixes:   []int{417753, 417754, 417755, 464990},
		},
		{
			Name:       "paritetbank",
			Country:    "by",
			...
			Color:      "#0360a7",
			Prefixes:   []int{416676, 416677, 427870, 429737, 437391, 459056},
		},
		{
			Name:       "priorbank",
			Country:    "by",
			...
			Color:      "#ffff00",
			Prefixes:   []int{413059, 416064, 417770, 437458, 445987, 458285, 471326, 472950, 480949, 491698, 542645, 548952, 558349},
		},
		{
			Name:       "trustbank",
			Country:    "by",
			...
			Color:      "#a81429",
			Prefixes:   []int{411856, 432231, 432232},
		},
		{
			Name:       "vtb",
			Country:    "by",
			...
			Color:      "#002e77",
			Prefixes:   []int{445451, 445452, 445453, 445454, 471346},
		},
	},
	CA: {
		{
	...
	CN: {
		{
			...
			Color:      "#319c8b",
			Prefixes:   []int{403361, 404117, 404118, 404119, 404120, 404121, 49102, 519412, 519413, 520082, 520083, 53591, 552599, 558730, 622836, 622837, 622848},
		},
		{
			Name:       "boc",
			Country:    "cn",
			...
			URL:        "http://www.boc.cn/",
			Color:      "#a71e32",
			Prefixes:   []int{409666, 438088, 622752, 622760},
		},
		{
			Name:       "boco",
			Country:    "cn",
			...
			Color:      "#023978",
			Prefixes:   []int{458123, 521899, 622260},
		},
		{
			Name:       "ccb",
			Country:    "cn",
			...
			Color:      "#0c69b0",
			Prefixes:   []int{436742, 436745, 621700, 622280},
		},
		{
			Name:       "ceb",
			Country:    "cn",
			...
			Color:      "#691585",
			Prefixes:   []int{356837, 356838, 356839, 356840, 406252, 406254, 425862, 481699, 486497, 543159, 622161, 622650, 622655, 622658, 628201, 628202},
		},
		{
			Name:       "cgb",
			Country:    "cn",
			...
			Color:      "#e60021",
			Prefixes:   []int{520152, 520382, 548844, 622568, 911121},
		},
		{
			Name:       "cib",
			Country:    "cn",
			...
			Color:      "#004097",
			Prefixes:   []int{451289, 451290, 486493, 486494, 486861, 523036, 524070, 527414, 622901, 622902, 622922},
		},
		{
			Name:       "citic",
			Country:    "cn",
			...
			Color:      "#c8151c",
			Prefixes:   []int{376966, 376968, 376969, 400360, 403391, 403392, 403393, 404157, 404158, 404159, 404171, 404172, 404173, 404174, 433666, 433667, 433668, 433669, 514906, 518212, 520108, 556617, 558916, 622680, 622688, 622689, 622690, 622916, 622918, 622919, 628206, 628208, 628209},
		},
		{
			Name:       "cmb",
			Country:    "cn",
			...
			Color:      "#b0110c",
			Prefixes:   []int{356885, 356886, 356889, 356890, 439188, 439225, 439226, 439227, 439228, 439229, 479229, 518710, 518718, 521302, 545619, 545623, 545947, 545948, 552534, 552580, 552581, 552582, 552583, 552584, 552585, 552586, 552588, 552589, 622575, 622576, 622577, 622578, 622579, 622581, 622588, 628262, 628362, 645621},
		},
		{
			Name:       "cmib",
			Country:    "cn",
			...
			Color:      "#0053b6",
			Prefixes:   []int{407405, 415599, 421869, 421870, 421871, 512466, 517636, 528948, 552288, 556610, 622600, 622601, 622602, 622603, 622622, 628258},
		},
		{
			Name:       "hxb",
			Country:    "cn",
			...
			Color:      "#d80c18",
			Prefixes:   []int{523959, 528708, 528709, 539867, 539868, 622636, 622637},
		},
		{
			Name:       "icbc",
			Country:    "cn",
			...
			Color:      "#c90000",
			Prefixes:   []int{427020, 427030, 530990, 622200, 622210, 622215, 622230, 622235, 955880},
		},
		{
			Name:       "pab",
			Country:    "cn",
			...
			Color:      "#e95303",
			Prefixes:   []int{435744, 435745, 526855, 528020, 622155, 622156, 622525, 622526, 622538, 998801, 998802},
		},
		{
			Name:       "spdb",
			Country:    "cn",
			...
			Color:      "#072154",
			Prefixes:   []int{622516, 622517, 622518, 622519, 622521, 622522, 622523},
		},
	},
	CY: {
		{
	...
	GB: {
		...
		},
		{
			...
			Color:      "#00adef",
			Prefixes:   []int{400115, 408367, 409400, 409401, 409402, 430532, 453978, 453979, 456725, 465858, 465859, 465860, 465861, 465862, 465863, 465864, 465865, 465866, 465867, 465901, 465902, 465911, 465921, 465922, 465923, 484419, 484420, 491748, 491749, 491750, 492902, 492912},
		},
		{
			Name:       "curve",
			Country:    "gb",
		...
		},
		{
			...
			Color:      "#0040bb",
			Prefixes:   []int{446238, 446291, 528683, 543429, 552073},
		},
		{
			Name:       "hsbc",
			Country:    "gb",
			...
			Color:      "#ee3226",
			Prefixes:   []int{465942, 465943, 465944, 486483, 543460},
		},
		{
			Name:       "lloydstsb",
			Country:    "gb",
		...
		},
		{
			...
			Color:      "#002878",
			Prefixes:   []int{454313, 465935, 475141, 489396},
		},
		{
			Name:       "natwest",
			Country:    "gb",
		...
		},
		{
			...
			Color:      "#ec0000",
			Prefixes:   []int{454742, 475714, 528689},
		},
		{
			Name:       "soldo",
			Country:    "gb",
	...
	IR: {
		...
		},
		{
			...
			Color:      "#b42728",
			Prefixes:   []int{627412, 627884, 639194},
		},
		{
	...
	KZ: {
		...
		},
		{
			...
			URL:        "http://kkb.kz/",
			Color:      "#008fb4",
			Prefixes:   []int{400303, 440564, 557834},
		},
		{
			Name:       "sberbank",
			Country:    "kz",
	...
	PL: {
		{
			...
			Color:      "#00abdf",
			Prefixes:   []int{401801, 474168, 474170, 552044},
		},
		{
			Name:       "ing-bsk",
			Country:    "pl",
			...
			Color:      "#ff6200",
			Prefixes:   []int{416040, 448379, 472817, 524382},
		},
		{
			Name:       "millennium",
			Country:    "pl",
			...
			Color:      "#c82059",
			Prefixes:   []int{487474, 512748, 512792, 534714, 542757},
		},
		{
			...
			Color:      "#fff533",
			Prefixes:   []int{402637, 429046, 543310},
		},
	},
	PT: {
		{
	...
	RU: {
		{
			...
			Color:      "#019d3c",
			Prefixes:   []int{424436, 424438, 424439, 424440, 424447, 520935, 520985, 552958},
		},
		{
			Name:       "alfabank",
			Country:    "ru",
			...
			Color:      "#f22f17",
			Prefixes:   []int{408396, 408397, 415428, 415429, 415481, 415482, 426101, 426113, 428905, 428906, 45841, 477964, 479004, 479087, 510126, 519778, 521178, 548601, 548655, 548673, 548674, 552175, 552186, 555933, 555947, 555949, 555957, 676371},
		},
		{
			Name:       "avangard",
			Country:    "ru",
		...
		},
		{
			...
			Color:      "#0088cf",
			Prefixes:   []int{419349, 427760, 427761, 520306, 527594},
		},
		{
			Name:       "gazprombank",
			Country:    "ru",
		...
		},
		{
			...
			Color:      "#274193",
			Prefixes:   []int{411791, 447818, 472345, 520373, 554759, 554781},
		},
		{
			Name:       "qiwi",
			Country:    "ru",
		...
		},
		{
			...
			Color:      "#fff300",
			Prefixes:   []int{446917, 447624, 462729, 462730, 462758, 510069, 510070, 515876, 533594},
		},
		{
			Name:       "renaissance",
			Country:    "ru",
		...
		},
		{
			...
			Color:      "#930d2d",
			Prefixes:   []int{510047, 513691, 542048},
		},
		{
			Name:       "sberbank",
			Country:    "ru",
		...
		},
		{
			...
			Color:      "#ffdd2d",
			Prefixes:   []int{437772, 437773, 521324, 548387, 553691},
		},
		{
			Name:       "trust",
			Country:    "ru",
		...
		},
		{
			...
			Color:      "#e3001a",
			Prefixes:   []int{485608, 489042, 490855, 531344},
		},
		{
			Name:       "uralsibbank",
			Country:    "ru",
		...
		},
		{
			...
			Color:      "#00498f",
			Prefixes:   []int{418869, 427229, 447520, 46223, 465206, 471487, 522598, 527883, 535082, 542033, 554386, 554393},
		},
		{
			Name:       "yandex",
			Country:    "ru",
	...
	TR: {
		{
			...
			Color:      "#4285f4",
			Prefixes:   []int{413252, 425669, 432072, 435508, 435509, 493837, 512754, 520932, 521807, 524347, 542110, 552608, 552609, 553056, 557113, 557829},
		},
		{
			Name:       "albaraka",
			Country:    "tr",
			...
			Color:      "#4285f4",
			Prefixes:   []int{417715, 432284, 432285, 534264, 547234, 548232},
		},
		{
			Name:       "bankasya",
			Country:    "tr",
			...
			Color:      "#4285f4",
			Prefixes:   []int{402275, 402276, 402280, 416987, 441033, 515849, 524384, 527585, 529462, 531334, 547799, 552529},
		},
		{
			Name:       "denizbank",
			Country:    "tr",
			...
			Color:      "#4285f4",
			Prefixes:   []int{403134, 408625, 409070, 411924, 423667, 424360, 424361, 426391, 426392, 441139, 450050, 450051, 460345, 460347, 472914, 489456, 510063, 510118, 510119, 512017, 512117, 514924, 520019, 520303, 521376, 543358, 543400, 543427, 544127, 544445, 544460, 546764, 547712, 549220, 554483, 558514},
		},
		{
			Name:       "finansbank",
			Country:    "tr",
			...
			Color:      "#4285f4",
			Prefixes:   []int{402277, 402278, 402563, 403082, 409364, 410147, 413583, 414388, 415565, 422376, 423277, 423398, 427311, 435653, 441007, 444029, 499850, 499851, 499852, 519324, 521022, 521836, 529572, 531157, 545120, 545616, 545847, 547567, 547800},
		},
		{
			Name:       "garanti",
			Country:    "tr",
		...
		},
		{
			...
			Color:      "#4285f4",
			Prefixes:   []int{415514, 492094, 492095, 498852, 510056, 521378, 540435, 543081, 552879},
		},
		{
			Name:       "hsbc",
			Country:    "tr",
			...
			Color:      "#4285f4",
			Prefixes:   []int{405913, 405917, 405918, 409071, 422629, 424909, 428240, 496019, 510005, 512651, 519399, 521045, 522054, 525413, 525795, 540643, 542254, 545183, 550472, 550473, 552143, 556030, 556031, 556033, 556034, 556665},
		},
		{
			Name:       "ingbank",
			Country:    "tr",
		...
		},
		{
			...
			Color:      "#4285f4",
			Prefixes:   []int{418342, 418343, 418344, 418345, 450803, 454318, 454358, 454359, 454360, 510152, 540667, 540668, 543771, 552096, 553058},
		},
		{
			Name:       "kuveytturk",
			Country:    "tr",
			...
			Color:      "#4285f4",
			Prefixes:   []int{402589, 402590, 402592, 403360, 403810, 410555, 410556, 424487, 431024, 511660, 512595, 518896, 520180, 525312, 547564},
		},
		{
			Name:       "sekerbank",
			Country:    "tr",
			...
			Color:      "#4285f4",
			Prefixes:   []int{403836, 411156, 411157, 411158, 411159, 411160, 433383, 433384, 494063, 494064, 521394, 521827, 525404, 530866, 539703, 547311, 549208, 549394},
		},
		{
			Name:       "teb",
			Country:    "tr",
			...
			URL:        "http://teb.com.tr/",
			Color:      "#4285f4",
			Prefixes:   []int{402458, 402459, 406015, 427707, 440247, 440273, 440293, 440294, 479227, 489494, 489495, 489496, 510138, 510139, 510221, 512753, 512803, 524346, 524839, 524840, 528920, 530853, 545124, 553090},
		},
		{
			Name:       "turkiyefinans",
			Country:    "tr",
			...
			Color:      "#4285f4",
			Prefixes:   []int{404952, 411685, 428462, 435627, 435628, 521848, 537719, 549294},
		},
		{
			Name:       "vakifbank",
			Country:    "tr",
			...
			Color:      "#4285f4",
			Prefixes:   []int{402940, 409084, 411724, 411942, 411943, 411944, 411979, 415792, 416757, 428945, 493840, 493841, 493846, 520017, 540045, 540046, 542119, 542798, 542804, 547244, 552101},
		},
		{
			Name:       "yapikredi",
			Country:    "tr",
			...
			Color:      "#4285f4",
			Prefixes:   []int{404809, 446212, 450634, 455359, 477959, 479794, 479795, 491205, 491206, 492128, 492130, 492131, 510054, 540061, 540062, 540063, 540122, 540129, 542117, 545103, 552645, 552659, 554422},
		},
		{
			Name:       "ziraatbankasi",
			Country:    "tr",
	...
	TW: {
		{
			...
			URL:        "http://www.anz.tw",
			Color:      "#003f67",
			Prefixes:   []int{442355, 468236, 515687, 539657, 552129},
		},
		{
			Name:       "cathaybk",
			Country:    "tw",
			...
			Color:      "#11a847",
			Prefixes:   []int{402310, 428368, 428430, 474832, 517478, 519936, 524106, 543375, 546696, 552197, 552579},
		},
		{
			Name:       "citibank",
			Country:    "tw",
			...
			Color:      "#0088cf",
			Prefixes:   []int{428440, 431178, 456313, 456318, 463670, 543374, 552000},
		},
		{
			Name:       "ctbcbank",
			Country:    "tw",
			...
			Color:      "#007d7d",
			Prefixes:   []int{400361, 406586, 416217, 418230, 421013, 421016, 421599, 430451, 431195, 447757, 451873, 456301, 456319, 481537, 483515, 515352, 517357, 523953, 533785, 533786, 537675, 537805, 540829, 543372, 546697, 547785, 552049, 559569},
		},
		{
			Name:       "esunbank",
			Country:    "tw",
			...
			Color:      "#009d99",
			Prefixes:   []int{404381, 409679, 416210, 439237, 457966, 457967, 461160, 464961, 483138, 486606, 511098, 512211, 512308, 515717, 515879, 515898, 519933, 519934, 519935, 520063, 520119, 521129, 522225, 522831, 523903, 523976, 524255, 528602, 528950, 539228, 539231, 542462, 542700, 552199, 555029},
		},
		{
			Name:       "fubon",
			Country:    "tw",
			...
			Color:      "#007c97",
			Prefixes:   []int{400357, 402987, 410523, 436314, 451445, 457952, 457953, 457956, 457957, 462410, 463781, 469531, 472634, 472635, 481509, 492496, 498713, 515709, 515716, 517951, 523764, 524108, 524132, 524264, 540945, 540966, 543377, 543381, 546600, 552046, 552345, 555033, 558805},
		},
		{
			Name:       "hncb",
			Country:    "tw",
		...
		},
		{
			...
			Color:      "#c42607",
			Prefixes:   []int{403879, 456314, 456317, 514738, 540853},
		},
		{
			Name:       "tcbbank",
			Country:    "tw",
	...
	UA: {
		{
			...
			Color:      "#ed1c2a",
			Prefixes:   []int{410247, 422605, 423719, 536364, 543259, 544904, 547994},
		},
		{
			...
			Color:      "#258b92",
			Prefixes:   []int{411948, 512439, 519745, 520662, 525822},
		},
		{
			Name:       "diamant",
			Country:    "ua",
			...
			Color:      "#0a2855",
			Prefixes:   []int{423174, 429453, 467936},
		},
		{
			Name:       "kredobank",
			Country:    "ua",
		...
		},
		{
			...
			Color:      "#06503c",
			Prefixes:   []int{515662, 545265, 555952, 557744},
		},
		{
			Name:       "otp",
			Country:    "ua",
			...
			Color:      "#a3d044",
			Prefixes:   []int{406760, 406788, 411749, 416955, 436323, 471362, 528534, 533194, 546886, 547266},
		},
		{
			Name:       "pravex",
			Country:    "ua",
			...
			Color:      "#701616",
			Prefixes:   []int{404764, 405247, 409089, 409388, 409625, 409881, 461278, 536444, 541701, 544142, 552670, 676274},
		},
		{
			Name:       "privatbank",
			Country:    "ua",
			...
			Color:      "#498d2f",
			Prefixes:   []int{410653, 414949, 414960, 414962, 414963, 423396, 424600, 432575, 434158, 440509, 440535, 440588, 458122, 462708, 473118, 473121, 475538, 476339, 516798, 516874, 516875, 516933, 521153, 521857, 530217, 532957, 536354, 544457, 545709, 552324, 558335, 558424},
		},
		{
			Name:       "procredit",
			Country:    "ua",
		...
		},
		{
			...
			Color:      "#fffb0b",
			Prefixes:   []int{413062, 414953, 418844, 423843, 462775, 512070, 512557, 512572, 516913, 518808, 529919, 532457, 535160, 536502, 542465, 543155, 543759, 545253, 548658, 548968, 552657, 557723, 557881},
		},
		{
			Name:       "ukreximbank",
			Country:    "ua",
		...
		},
		{
			...
			Color:      "#005596",
			Prefixes:   []int{401800, 403471, 510449, 512100, 512743, 516854, 517725, 517818, 518654, 521833, 522654, 522797, 522967, 524872, 525672, 525792, 527412, 528812, 531007, 531725, 532343, 539845, 540305, 540617, 540637, 543438, 547313, 547914, 548883, 549146, 549582, 549824, 549896, 553391, 557110, 670651, 670669, 670877, 671103, 677237, 677490},
		},
		{
			Name:       "ukrsibbank",
			Country:    "ua",
			...
			Color:      "#04703d",
			Prefixes:   []int{407361, 407368, 417232, 427830, 434343, 516930, 529578, 533037, 535129},
		},
		{
			Name:       "ukrsotsbank",
			Country:    "ua",
			...
			Color:      "#a50931",
			Prefixes:   []int{402191, 417284, 431153, 476009, 487412},
		},
		{
			Name:       "unicreditbank",
			Country:    "ua",
			...
			Color:      "#e3001a",
			Prefixes:   []int{408339, 430333, 430364, 432109, 487410, 510467, 512789, 515794, 518282, 525759, 546644, 553091},
		},
	},
	US: {
		{
		...
		},
		{
			...
			Color:      "#28ace2",
			Prefixes:   []int{414706, 432745, 432746, 432747, 432748, 439707, 439708, 469596, 486895, 486896, 514021, 514210, 514735, 514736, 514887, 514888, 514889, 514890, 514891, 514892, 515665, 517751, 517788, 523917, 524049, 540278, 541021, 545525, 545526, 546638, 547783, 552321, 552322},
		},
		{
			Name:       "capitalonebank",
			Country:    "us",
			...
			Color:      "#004779",
			Prefixes:   []int{400112, 400229, 400294, 400344, 400393, 400498, 401797, 401854, 402118, 402605, 402621, 403060, 403444, 403611, 403652, 403694, 405608, 405616, 410608, 410673, 411358, 411507, 412174, 414311, 414709, 415417, 415540, 415557, 415573, 415912, 415938, 419310, 430523, 430572, 430598, 438864, 441702, 450214, 450215, 477596, 477597, 479124, 480213, 486236, 489966, 490915, 493109, 493422, 494065, 514026, 517805, 518274, 518621, 518811, 520197, 528604, 529107, 529115, 529123, 529131, 529149, 529156, 529164, 529172, 529180, 529198, 530279, 530287, 530295, 530709, 530758, 539619, 539700, 539858, 543211, 545534, 545756, 546622, 546630, 547281, 552851, 552869, 554931, 557009, 557017, 557108, 557116},
		},
		{
			Name:       "chase",
			Country:    "us",
		...
		},
		{
			...
			Color:      "#254094",
			Prefixes:   []int{415786, 444512, 542432, 548009},
		},
		{
			Name:       "googlewallet",
			Country:    "us",
		...
		},
		{
			...
			Color:      "#004990",
			Prefixes:   []int{404195, 419672, 432732, 435899, 441709, 446106, 472776, 475034, 475423, 475427, 487211, 531108},
		},
		{
			Name:       "navyfederal",
			Country:    "us",
			...
			Color:      "#0f4471",
			Prefixes:   []int{400022, 403216, 406041, 406095, 406315},
		},
		{
			Name:       "payoneer",
			Country:    "us",
		...
		},
		{
			...
			Color:      "#ef7622",
			Prefixes:   []int{442505, 451805, 486560, 519667, 519669, 546540, 552393, 553693, 553694, 557621},
		},
		{
			Name:       "tdbank",
			Country:    "us",
			...
			Color:      "#35b233",
			Prefixes:   []int{401777, 402944, 408537, 408540, 415874, 417207, 417208, 429482, 432855, 438766, 449163, 465652, 479213},
		},
		{
			Name:       "usbank",
			Country:    "us",
			...
			Color:      "#0c2074",
			Prefixes:   []int{404645, 414780, 420719, 424604, 436618, 446053, 470758, 476153, 521679},
		},
		{
			Name:       "wellsfargo",
			Country:    "us",
